...
```{r}
png('Image/corrplot.png',width=310,height=400,res=150)
library('corrplot')
...
```{r}
jpeg('Image/scatter1.jpg',width=720,height=640)
p1 <- ggplot(data.1, aes(x=AGE,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10))
p2 <- ggplot(data.1, aes(x=WEIGHT,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
p3 <- ggplot(data.1, aes(x=HEIGHT,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
p4 <- ggplot(data.1, aes(x=ADIPOSITY,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
p5 <- ggplot(data.1, aes(x=NECK,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10))
p6 <- ggplot(data.1, aes(x=CHEST,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
p7 <- ggplot(data.1, aes(x=ABDOMEN,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
p8 <- ggplot(data.1, aes(x=HIP,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
p9 <- ggplot(data.1, aes(x=THIGH,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10))
p10 <- ggplot(data.1, aes(x=KNEE,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
p11 <- ggplot(data.1, aes(x=ANKLE,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
p12 <- ggplot(data.1, aes(x=BICEPS,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
p13 <- ggplot(data.1, aes(x=FOREARM,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10))
p14 <- ggplot(data.1, aes(x=WRIST,y=BODYFAT))+geom_point(size=0.7)+
  geom_smooth(method='lm')+theme_bw()+theme(text = element_text(size=10),axis.title.y=element_blank())
...
summary(model.raw)
jpeg('Image/diag1.jpg',width=500,height=450)
autoplot(model.raw)
dev.off()
require(car)
...
summary(model.full)
jpeg('Image/diag2.jpeg',width=400,height=300)
autoplot(model.full)
dev.off()
...
jpeg('Image/cook.jpeg',width=500,height=300)
...
r2 = c('DurbinWatson test','Score test','gvlma test','Shapiro-Wilk test')
...
jpeg('Image/lasso.jpeg',width=300,height = 250)
plot(cvfit)
...
gt <- gTree(children=gList(table, title))
jpeg('Image/msummary.jpg')
grid.draw(gt)
dev.off()
jpeg('Image/diag2.jpg',width=400,height=300)
autoplot(m.final)
dev.off()
